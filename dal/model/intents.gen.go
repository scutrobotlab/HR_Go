...
type Intent struct {
	...
	Rank        int32          `gorm:"column:rank;not null;comment:意愿顺序" json:"rank"`
	Group_      string         `gorm:"column:group;not null;comment:意愿组别" json:"group"`
	Parallel    bool           `gorm:"column:parallel;not null;comment:是否平行志愿" json:"parallel"`
