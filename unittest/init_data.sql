...
VALUES (1, 'E-mail', 'email', 'text-field-email', 1, '[]', NULL, NULL, NULL, NULL, NULL),
       ...
       (3, '年级', 'grade', 'select', 1, '[\"大一\", \"大二\", \"大三\", \"大四\", \"其他\"]', NULL, NULL, NULL, NULL, NULL),
       (4, '学院', 'school', 'select', 1, '[\"机械与汽车工程学院\", \"建筑学院\", \"土木与交通学院\", \"电子与信息学院\", \"材料科学与工程学院\", \"化学与化工学院\", \"轻工科学与工程学院\", \"食品科学与工程学院\", \"数学学院\", \"物理与光电学院\", \"经济与金融学院\", \"旅游管理系\", \"电子商务系\", \"自动化科学与工程学院\", \"计算机科学与工程学院\", \"电力学院\", \"生物科学与工程学院\", \"环境与能源学院\", \"软件学院\", \"工商管理学院（创业教育学院）\", \"公共管理学院\", \"马克思主义学院\", \"外国语学院\", \"法学院（知识产权学院）\", \"新闻与传播学院\", \"艺术学院\", \"体育学院\", \"设计学院\", \"医学院（生命科学研究院）\", \"国际教育学院\", \"峻德书院\", \"铭诚书院\", \"生物医学科学与工程学院\", \"吴贤铭智能工程学院\", \"前沿软物质学院\", \"微电子学院\", \"未来技术学院\", \"海洋科学与工程学院\"]', NULL, NULL, NULL, NULL, NULL),
       (5, '专业', 'major', 'text-field', 1, '[]', NULL, 16, NULL, NULL, NULL),
       (6, '本学年校区', 'campus', 'select', 1, '[\"五山校区\", \"大学城校区\", \"广州国际校区\"]', NULL, NULL, NULL,  NULL, NULL),
       (7, '自我介绍', 'self_intro', 'textarea', 0, '[]', NULL, 3000, NULL, NULL, NULL),
       (8, '促使你来报名的最主要原因', 'apply_main_reason', 'select', 1, '[\"同学分享\", \"老师介绍\", \"微信公众号@华工机器人实验室\", \"bilibili@华工机器人实验室\", \"RoboMaster赛事\", \"中小学阶段的机器人竞赛经历\", \"校内线下招新\", \"华工机器人协会\", \"华工机器人协会校内赛\", \"不记得\", \"其它渠道\"]', NULL, NULL, NULL, NULL, NULL),
...
VALUES (1, '31-501', '', 0, current_timestamp(), 0, '', '', '电控', NULL, NULL, current_timestamp(), 0),
       ...
       (4, '31-504', '', 0, current_timestamp(), 0, '', '', '宣运', NULL, NULL, current_timestamp(), 0);
UNLOCK TABLES;
